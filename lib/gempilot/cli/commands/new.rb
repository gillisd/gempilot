    ...
    module Commands
      class New < Command
        ...
        def add_class(constant)
          ...
          constant = "#{namespaces.join('::')}::#{class_name}"
          print_banner("Adding class", constant)
        ...
        def add_module(constant)
          ...
          constant = "#{namespaces.join('::')}::#{mod_name}"
          print_banner("Adding module", constant)
        ...
        def add_command(name)
          ...
          print_banner("Adding command", command_name)
        ...
        def print_banner(action, name)
          puts
          label = colors.bold(colors.cyan(name))
          puts "#{colors.bright_white(action)} #{label}..."
          puts
        end
      end
    end
